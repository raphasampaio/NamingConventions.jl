...
function test_decoder()
    ...
    @test decode("flat case") == ["flat", "case"]
...
function test_camel_case()
    ...
    @test NamingConventions.convert(FlatCase, CamelCase, "flat case") == "flatCase"
    ...
    @test NamingConventions.convert(CamelCase, "flat case") == "flatCase"
...
function test_flat_case()
    ...
    @test NamingConventions.convert(FlatCase, FlatCase, "flat case") == "flat case"
    ...
    @test NamingConventions.convert(FlatCase, "camelCase") == "camel case"
    @test NamingConventions.convert(FlatCase, "flat case") == "flat case"
    @test NamingConventions.convert(FlatCase, "kebab-case") == "kebab case"
    @test NamingConventions.convert(FlatCase, "PascalCase") == "pascal case"
    @test NamingConventions.convert(FlatCase, "SCREAMING_SNAKE_CASE") == "screaming snake case"
    @test NamingConventions.convert(FlatCase, "snake_case") == "snake case"
...
function test_kebab_case()
    ...
    @test NamingConventions.convert(FlatCase, KebabCase, "flat case") == "flat-case"
    ...
    @test NamingConventions.convert(KebabCase, "flat case") == "flat-case"
...
function test_pascal_case()
    ...
    @test NamingConventions.convert(FlatCase, PascalCase, "flat case") == "FlatCase"
    ...
    @test NamingConventions.convert(PascalCase, "flat case") == "FlatCase"
...
function test_screaming_snake_case()
    ...
    @test NamingConventions.convert(FlatCase, ScreamingSnakeCase, "flat case") == "FLAT_CASE"
    ...
    @test NamingConventions.convert(ScreamingSnakeCase, "flat case") == "FLAT_CASE"
...
function test_snake_case()
    ...
    @test NamingConventions.convert(FlatCase, SnakeCase, "flat case") == "flat_case"
    ...
    @test NamingConventions.convert(SnakeCase, "flat case") == "flat_case"
...
function is(::Type{ReversePascalCase}, s::AbstractString)
    return occursin(r"^[a-z]+([A-Z][a-z0-9]*)*$", s)
end

function encode(::Type{ReversePascalCase}, s::AbstractVector{<:AbstractString})::String
    return s[end] * join(titlecase.(s[1:end-1]))
end

function decode(::Type{ReversePascalCase}, s::AbstractString)::Vector{String}
